...
private struct MainWindowTitlebarControlsHostView: View {
    ...
    var body: some View {
        MainWindowTitlebarControls(
            ...
            assistantTitle: self.model.localized(zh: "AI 助手", en: "Assistant"),
            assistantHelpText: self.model.localized(zh: "打开 AI 助手窗口", en: "Open the assistant window"),
            onAssistant: { self.model.openAssistantWindow() },
