...
public struct LocalizationStore: Sendable, Equatable {
    ...
    private static let catalog: [ResolvedLanguage: [LocalizedTextKey: String]] = [
        .english: [
            ...
            .requestLogsFilterHint: "Adjust the time range, client source, local API key, account label, and model here. Click Query to apply new filters, or Reload to fetch the current result set again.",
            .requestLogsPendingFiltersHint: "Filters or sorting changed. Click Query to apply them.",
            .requestLogsPendingFiltersCompactHint: "Query to apply changes",
        ...
        .zhHans: [
            ...
            .requestLogsFilterHint: "在这里调整时间范围、客户端来源、本地 API Key、账号标签和模型。修改筛选后点击查询应用，点击刷新可重新获取当前结果。",
            .requestLogsPendingFiltersHint: "筛选条件或排序已变更，点击查询后更新结果。",
            .requestLogsPendingFiltersCompactHint: "点击查询应用变更",
